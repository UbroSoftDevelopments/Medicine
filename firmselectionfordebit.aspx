<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="firmselectionfordebit.aspx.cs" Inherits="Medicine.firmselectionfordebit" %>
...
<h2 class="w3-light-blue">Select Party Or Store Name</h2>
  <asp:Label ID="lblmessage" runat="server" Text=""></asp:Label><br />
    ...
    <asp:DropDownList CssClass="w3-input w3-sand w3-border w3-round w3-mobile" 
        ...
        <asp:ListItem Selected="True" Text="--Select Company/Firm Name--" Value="-1"></asp:ListItem>
    </asp:DropDownList>
    ...
    <asp:Button ID="btselect"  class=" w3-round-xxlarge w3-btn w3-purple" 
        runat="server" Text="Select" onclick="btselect_Click1" />
    </center>
    </div>
    </div>
