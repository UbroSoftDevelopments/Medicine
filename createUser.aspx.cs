...
namespace Medicine
{
    public partial class createUser : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                DataManager.DataSet1TableAdapters.usertypeTableAdapter utta = new DataManager.DataSet1TableAdapters.usertypeTableAdapter();
                ...
                for (int x = 0; x < utdt.Rows.Count; x++)
                {
                    ...
                    drpdwnUserType.Items.Insert(x + 1, new ListItem("" + utr.usertype, "" + utr.sno));
                }
            }
        }
        ...
        protected void addUser(object sender, EventArgs e)
        {
            ...
            {
                lblErrors.Text = "Enter User Name";
                return;
            }
        ...
        public void changeStatus(object sender, EventArgs e)
        {
            ...
            DataManager.DataSet1TableAdapters.siteusersTableAdapter sta = new DataManager.DataSet1TableAdapters.siteusersTableAdapter();
